...
import com.pachong.interfaces.impl.XueQiuTodayDetailsConnectionImpl;
import com.stocks.common.CONSTANT;
import com.stocks.service.IO.FileService;
import com.sun.java_cup.internal.runtime.Symbol;

public class XueQiuTodayDetailsPaChong extends PaChong {
	protected int cycleRetryTimes = 4;
	protected int numberOfThread = 1;
	private static final Logger LOGGER = Logger.getLogger(XueQiuTodayDetailsPaChong.class);
...
//				Connections.undoURL.add(paramAfter);
	...
	public void startOneCycle() {
		...
		for (int i = 0; i < numberOfThread; i++) {
			XueQiuTodayDetailsConnectionImpl connectionImpl = new XueQiuTodayDetailsConnectionImpl();
